...
function getTags(blockType) {
  switch (blockType) {
    ...
    case _draftJsTools.BLOCK_TYPE.CODE:
      return ['pre', 'code'];
    case _draftJsTools.BLOCK_TYPE.MEDIA:
      return ['figure'];
    default:
      return ['div'];
  }
      ...
      return entityPieces.map(function (_ref) {
        ...
        var content = stylePieces.map(function (_ref3) {
          ...
          if (style.has(CODE)) {
            ...
            content = blockType === _draftJsTools.BLOCK_TYPE.CODE ? content : '<code>' + content + '</code>';
          }
          if (blockType === _draftJsTools.BLOCK_TYPE.MEDIA) {
