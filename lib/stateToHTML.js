...
var ENTITY_ATTR_MAP = (_ENTITY_ATTR_MAP = {}, _defineProperty(_ENTITY_ATTR_MAP, _draftJsUtils.ENTITY_TYPE.LINK, { url: 'href', rel: 'rel', target: 'target', title: 'title' }), _defineProperty(_ENTITY_ATTR_MAP, _draftJsUtils.ENTITY_TYPE.IMAGE, { src: 'src', alt: 'alt' }), _ENTITY_ATTR_MAP);
    ...
    value: function renderBlockContent(block) {
      ...
      return entityPieces.map(function (_ref) {
        ...
        if (entityType === _draftJsUtils.ENTITY_TYPE.LINK) {
          ...
          return '<a href="' + _attrs['data-original-url'] + '"><img src="' + _attrs.src + '" alt="' + _attrs.alt + '" /></a>';
        } else {
          return content;
        }
      }).join('');
