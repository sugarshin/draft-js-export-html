...
var ENTITY_ATTR_MAP = _defineProperty({}, _draftJsUtils.ENTITY_TYPE.LINK, { url: 'href', rel: 'rel', target: 'target', title: 'title' });

// Map entity data to element attributes.
var DATA_TO_ATTR = _defineProperty({}, _draftJsUtils.ENTITY_TYPE.LINK, function (entityType, entity) {
...
function getTags(blockType) {
  switch (blockType) {
    ...
    case _draftJsUtils.BLOCK_TYPE.CODE:
      return ['pre', 'code'];
    case _draftJsUtils.BLOCK_TYPE.MEDIA:
      return ['figure'];
    default:
      return ['div'];
  }
    ...
    value: function renderBlockContent(block) {
      ...
      return entityPieces.map(function (_ref) {
        ...
        var content = stylePieces.map(function (_ref3) {
          ...
          if (blockType === _draftJsUtils.BLOCK_TYPE.MEDIA) {
